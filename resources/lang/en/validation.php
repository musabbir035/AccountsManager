...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'balance' => [
            ...
            'null_balance_type' => 'Please select balance type.'
        ],
        'type' => [
            'required' => 'Please select a type.',
            'integer' => 'Invalid type.',
            'between' => 'Invalid type.'
        ],
        'description' => [
        ...
        'customer_id' => [
            'exists' => 'Customer not found.'
        ],
        'product_id' => [
            'exists' => 'Product not found.'
        ],
        'receipt_id' => [
            'exists' => 'Receipt not found.'
        ]
    ],
    ...
    */
    ...
    'email.customer.unique' => 'Provided email address already belongs to another customer.',
    'mobile.customer.unique' => 'Provided mobile number already belongs to another customer.',
